    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="./assets/products/12.png" style="height:120px" alt="Cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Apple iPhone X</h5>
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-raleway w-25">
                                <button class="qty-down border bg-light rounded-start" data-id="product2">
                                    <i class="fas fa-angle-down"></i>
                                </button>
                                <input type="text" class="qty-input border px-2 text-center w-100 bg-light" value="1" disabled data-id="product2">
                                <button class="qty-up border bg-light rounded-end" data-id="product2">
                                    <i class="fas fa-angle-up"></i>
                                </button>
                            </div>
                            <button type="submit" class="btn font-baloo text-danger border-end rounded-0 px-3">Delete</button>
